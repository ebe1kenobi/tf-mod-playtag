...
namespace Patcher {
  public class Patcher {
    ...
    private static string modModulePath = Path.GetFullPath("TowerfallModPlayTag.dll");
    ...
    public void Patch(string target = "TowerFall.exe") {
      ...
      Console.WriteLine("Writing {0}", target + ".TowerfallModPlayTag.exe");
      baseModule.Write(target+ ".TowerfallModPlayTag.exe");
